...
from geoalchemy2 import Geometry  # Enabled
...
class Migrant(Base):
    ...
    location = Column(Geometry('POINT', srid=4326))  # Enabled
    ...
    __table_args__ = (
        ...
        Index('idx_migrant_location', 'location', postgresql_using='gist'),  # Enabled
...
class Encounter(Base):
    ...
    # Geospatial fields for encounter location
    location_lat = Column(Float)
    location_lng = Column(Float)
    location = Column(Geometry('POINT', srid=4326))  # Enabled
    ...
    __table_args__ = (
        ...
        Index('idx_encounter_location', 'location', postgresql_using='gist'),  # Enabled
    )
